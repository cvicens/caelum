...
static const u1_t PROGMEM APPKEY[16]
    = { 0x67, 0x09, 0x46, 0x1E, 0x33, 0x2B, 0xB5, 0xDB, 0x55, 0x45, 0xB7, 0x71, 0x5E, 0xDF, 0x94, 0xE5 };
// static const u1_t PROGMEM APPKEY[16] = { 0xBA, 0xE1, 0x46, 0x53, 0x2C, 0xB1, 0x73, 0x4B, 0xAF, 0x83, 0x6C, 0xD8,
// 0x30, 0x7F, 0xD8, 0x51 };
...
uint8_t* reserve_payload()
{
    uint8_t size { 0 };
    for (int i = 0; i < LoRaWan::numSensors; i++) {
        size += LoRaWan::sensor[i]->getPayloadSize();
    }
...
{
    uint8_t* __payload = reserve_payload();
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        LMIC_setTxData2(mask, __payload, latestIndex, 0);
    }
